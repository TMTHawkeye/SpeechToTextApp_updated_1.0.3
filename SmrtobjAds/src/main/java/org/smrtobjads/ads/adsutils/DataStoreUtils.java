...
public class DataStoreUtils {
    private final static String PREF_NAME = "data_store_pref";

    private final static String KEY_INSTALL_TIME = "KEY_INSTALL_TIME";

    private final static String KEY_LANGUAGE_SELECTED = "KEY_LANGUAGE_SELECTED";
    ...
    public static Boolean getLanguageSelected(Context context, Boolean defValue) {
        SharedPreferences pre = context.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE);
        return pre.getBoolean(KEY_LANGUAGE_SELECTED, defValue);
    }

    public static void setKeyLanguageSelected(Context context, Boolean isLanguageSelected) {
        SharedPreferences pre = context.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE);
        pre.edit().putBoolean(KEY_LANGUAGE_SELECTED, isLanguageSelected).apply();
    }
