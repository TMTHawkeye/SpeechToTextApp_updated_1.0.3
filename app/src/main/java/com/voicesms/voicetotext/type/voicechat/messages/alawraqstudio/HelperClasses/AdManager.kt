...
//                    isLoadingAd = false
//                    loadTime = Date().time
//                    Log.d("LOG_TAG", "onAdLoaded for others")
//                }
//                override fun onAdFailedToLoad(loadAdError: LoadAdError) {
//                    isLoadingAd = false
//                    Log.d("LOG_TAG", "onAdFailedToLoad:  for others " + loadAdError.message)
//                }
//            }
//        )
//    }
...
////        if (isShowingAd) {
////            Log.d("LOG_TAG", "The app open ad is already showing  for others")
////            return
////        }
////        if (!isAdAvailable()) {
////            Log.d("LOG_TAG", "The app open ad is not ready yet  for others")
...
////        }
////
////        Log.d("LOG_TAG", "Will show ad app open for others")
////
...
////                    appOpenAd = null
////                    isShowingAd = false
////                    Log.d("LOG_TAG", "onAdDismissedFullScreenContent app open for others")
////
////                    onShowAdCompleteListener.onShowAdComplete()
//////                        if (googleMobileAdsConsentManager.canRequestAds) {
////                    loadAd(activity)
...
////                    appOpenAd = null
////                    isShowingAd = false
////                    Log.d("LOG_TAG", "onAdFailedToShowFullScreenContent: app open for others" + adError.message)
////
////                    onShowAdCompleteListener.onShowAdComplete()
//////                        if (googleMobileAdsConsentManager.canRequestAds) {
////                    loadAd(activity)
...
////
////                override fun onAdShowedFullScreenContent() {
////                    Log.d("LOG_TAG", "onAdShowedFullScreenContent app open for others")
////                }
////            }
////        isShowingAd = true
